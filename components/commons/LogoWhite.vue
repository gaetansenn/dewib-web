<template>
  <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
    y="0px" viewBox="0 0 464.9 117" style="enable-background:new 0 0 464.9 117;" xml:space="preserve">
    <g>
      <path fill="currentColor" d="M87.6,100.5c-15.5,13.1-35.4,13.6-54.5,13.6H0V0h44.3c3.2,0,6.3,0,9.5,0.2c5.2,0.2,17.4,1.1,29.6,9
      ...
      <path fill="currentColor"
        d="M334,22V6.5h15.2V22H334z M334.1,114.1V35.2h15.3v78.9C349.4,114.1,334.1,114.1,334.1,114.1z" />
      <path fill="currentColor" d="M456.4,100.2c-5.8,7.1-17.6,16-39.4,16c-13.1,0-20.4-2.6-25.7-5.2c-1.9-1-5.2-2.4-8.7-5.8v8.9h-15.3V0h15.3
      ...
      <path fill="currentColor" d="M319.3,36.4v40.3c0,24.9-14.7,40.4-38.5,40.4c-13.6,0-24.3-5.1-30.9-14.2c-6.6,9.1-17.3,14.2-30.9,14.2h-16.7
		v-15.1H219c10.7,0,23.3-4.4,23.3-25.2h15.1c0,20.9,12.7,25.2,23.3,25.2c10.7,0,23.3-4.4,23.3-25.2V36.4H319.3z" />
      <path fill="currentColor" d="M159.1,109.4L159.1,109.4z" />
      <path fill="currentColor" d="M166.8,117c-0.5,0-11.3-0.2-22.1-5.4c-10.6-5.1-23.2-15.8-23.2-38.2c0-22.7,10.5-34.4,19.2-40.3
